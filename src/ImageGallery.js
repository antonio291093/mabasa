...
const ImageGallery = () => {
  ...
  return (
    <div className="gallery-wrapper">
      <div className={`container-img ${currentGallery === 1 ? '' : 'hidden'}`} id="gallery1">
      ...
      <div className={`container-img ${currentGallery === 2 ? '' : 'hidden'}`} id="gallery2">
        <div className="box-img">
          <a href="#">
            <figure>
      ...
      <div className="nav-arrow left-arrow" onClick={() => showGallery('prev')}>&#9664;</div>
      <div className="nav-arrow right-arrow" onClick={() => showGallery('next')}>&#9654;</div>
    </div>
  );
};
